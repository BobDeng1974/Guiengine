...
CEGUI::OpenGL3Renderer* Guiengine::GUI::m_renderer = nullptr;
void Guiengine::GUI::init(const std::string& resourceDirectory) {
...
void Guiengine::GUI::setMouseCursor(const std::string & imageFile)
{
	m_context->getMouseCursor().setDefaultImage(imageFile);
}

void Guiengine::GUI::showCursor()
{
	m_context->getMouseCursor().show();
}

void Guiengine::GUI::hideCursor()
{
...
void Guiengine::GUI::onSDLEvent(SDL_Event & evnt)
{
...
void Guiengine::GUI::loadScheme(const std::string& schemeFile) {
	CEGUI::SchemeManager::getSingleton().createFromFile(schemeFile);
}

CEGUI::Window* Guiengine::GUI::createWidget(const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
...
CEGUI::Window* Guiengine::GUI::createWidget(CEGUI::Window* parent, const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
	CEGUI::Window* newWindow = CEGUI::WindowManager::getSingleton().createWindow(type, name);
...
void Guiengine::GUI::setWidgetDestRect(CEGUI::Window* widget, const glm::vec4& destRectPerc, const glm::vec4& destRectPix) {
...
void Guiengine::GUI::setFont(const std::string& fontFile) {
