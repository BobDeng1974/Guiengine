...
namespace Guiengine {
	...
	void DebugRender::init(){
		...
		// Unbinding vertex array all is unbinded
		glBindVertexArray(0);
	...
	void DebugRender::drawLine(const glm::vec2& a, const glm::vec2& b, const ColorRGBA& color) {
		int i = m_verts.size();
	...
	void DebugRender::drawBox(const glm::vec4 & destRect, const ColorRGBA & color, float angle){
	...
	void DebugRender::drawCircle(const glm::vec2 & center, const ColorRGBA & color, float radius){
